...
<body class="bg-light">
    ...
    <div class="container my-5">
        ...
        <ul class="nav nav-tabs shadow-sm bg-white rounded mb-4" id="academicTabs" role="tablist">
            ...
            <li class="nav-item">
                <button class="nav-link fw-semibold" id="jadwal-tab" data-bs-toggle="tab" data-bs-target="#jadwal-pane" type="button" role="tab" onclick="switchModule('jadwal')">Jadwal Kuliah</button>
            </li>
        </ul>
